...
public class RadioButtonApp extends JFrame {
	...
	public RadioButtonApp ()
	{
		...
		q1 = new JLabel(" 1. Who killed Goliath?");
		pnl1.add(q1);
		
		pnlchoices1 = new JPanel();
		pnlchoices1.setLayout(new GridLayout(2,2));		
		a1 = new JRadioButton(" David");
		a2 = new JRadioButton(" Paul");
		a3 = new JRadioButton(" Matthew");
		a4 = new JRadioButton(" James");
		pnlchoices1.add(a1);
		pnlchoices1.add(a2);
		pnlchoices1.add(a3);
		pnlchoices1.add(a4);
		...
		q2 = new JLabel(" 2. What is the product of 5 multiplied by 16?");
		pnl2.add(q2);
		
		pnlchoices2 = new JPanel();
		pnlchoices2.setLayout(new GridLayout(2,2));		
		b1 = new JRadioButton(" 95");
		b2 = new JRadioButton(" 85");
		b3 = new JRadioButton(" 90");
		b4 = new JRadioButton(" 80");
		pnlchoices2.add(b1);
		pnlchoices2.add(b2);
		pnlchoices2.add(b3);
		pnlchoices2.add(b4);
		...
		pnlchoices3.setLayout(new GridLayout(2,2));		
		...
		pnlchoices4.setLayout(new GridLayout(2,2));		
		...
		q5 = new JLabel(" 5. Where was Moses born?");
		pnl5.add(q5);
		
		pnlchoices5 = new JPanel();
		pnlchoices5.setLayout(new GridLayout(2,2));		
		e1 = new JRadioButton(" Egypt");
		e2 = new JRadioButton(" Samaria");
		e3 = new JRadioButton(" Greece");
		e4 = new JRadioButton(" Israel");
		pnlchoices5.add(e1);
		pnlchoices5.add(e2);
		pnlchoices5.add(e3);
		pnlchoices5.add(e4);
		...
		ok = new JButton("CLICK HERE TO SHOW YOUR SCORE");
	...
	{
		RadioButtonApp application = new RadioButtonApp();
